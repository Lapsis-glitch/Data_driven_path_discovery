...
def main():
    ...
    # X = np.loadtxt('/home/rat/Nancy_D/GNN/trialanine/internal_coords.dat')
    # X = np.loadtxt('/home/rat/Nancy_D/GNN/trialanine/cartesian_coords.dat')

    # X = np.loadtxt('/home/rat/Nancy_D/GNN/trialanine/cartesians_aligned_0.15.dat')
    X = np.load('/home/rat/Nancy_D/GNN/trialanine/sensitivity/smalldata_arrays/node_s.npy')
    ...
    #         random_state=123,
    #         n_clusters=5,
    #         centroids_csv="kmeans_5_centroids_cartesian_grad.csv",
    #         clusters_csv="kmeans_5_point_assignments_cartesian_grad.csv"
    #     # must pass k here
    #     )
    #
